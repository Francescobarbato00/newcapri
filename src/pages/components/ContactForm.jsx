...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <section className="bg-white max-w-7xl mx-auto py-10 px-5 fade-in">
        {/* Breadcrumb */}
        <div className="text-sm mb-4 text-gray-500">
          <a href="/" className="hover:underline">Home</a> <span className="mx-2">/</span> <span>Contattaci</span>
        </div>
        ...
        <div className="mb-8">
          <h1
            ...
            style={{ fontFamily: "'Titillium Web', sans-serif", fontWeight: 300, textAlign: 'left' }}
          >
            Contattaci
          </h1>
        </div>
