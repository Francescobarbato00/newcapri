...
export default function SubscribeForm({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[9999]">
      {/* Contenitore della modale responsive */}
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-11/12 sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-bold">Iscrizione al Convegno</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              value={formData.note}
              onChange={handleChange}
              className="w-full border rounded px-3 py-2 h-20 text-sm sm:text-base"
            ></textarea>
          </div>
