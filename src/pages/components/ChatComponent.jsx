...
const ChatComponent = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 px-5 flex flex-col items-end z-50">
      ...
      {isOpen && (
        <div
          className="chat-window mt-4 w-96 sm:w-80 h-[500px] sm:h-[400px] bg-white rounded-lg shadow-2xl transition-all duration-300 ease-in-out flex flex-col border border-gray-300 overflow-hidden"
        >
